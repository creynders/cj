...
var simulate = function(nCands, nJudgements, algorithm, thr, AP, iters, results, callback){
    if(iters>0){
      ...
      doJudgements(algorithm, players, thr, AP, nJudgements, [], function(players){
        ...
        for(var i=0; i<players.length; i++){
          var pl = {};
          pl.iteration = iters;
          pl.judgement = players[i].judgement;
        ...
        process.nextTick(function() {simulate(nCands, nJudgements, algorithm, thr, AP, --iters, results, callback);});
      });
    } else {
        csv
